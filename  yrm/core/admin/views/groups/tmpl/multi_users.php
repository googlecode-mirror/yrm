...
JToolBarHelper::title( JText::_( 'MANAGE_GROUP_ADD_MULTI_USERS').' <small>['.$this->group->name.']</small>' , 'user.png' );
...
<form action="index.php" method="post" name="adminForm">
	<table>
		<tr>
			...
			<td width="20%">
				<?php 
					echo JText::_('ADD_MULTI_USER_START').JHTML::_('calendar', $this->start, 'gu_start', 'gu_start', '%Y-%m-%d %H:%M:%S', array('class'=>'inputbox', 'size'=>'25',  'maxlength'=>'19')); 
				?>
			</td>
			<td width="20%">
				<?php 
					echo JText::_('ADD_MULTI_USER_END').JHTML::_('calendar', $this->end, 'gu_end', 'gu_end', '%Y-%m-%d %H:%M:%S', array('class'=>'inputbox', 'size'=>'25',  'maxlength'=>'19')); 
				?>
			</td>
