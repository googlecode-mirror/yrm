...
$document->addScript('components/com_yos_resources_manager/assets/js/user.js');
...
$xmlUrl = 'index.php?option=' . $this->option . '&controller=user&task=xmltree&uid=' . $this->uid;
...
<tr>
	...
	<td width="300" valign="top">
		...
		<tr>
			...
			<td><!--<input type="text" name="start_date" size="20" value="<?php echo $this->nowdate; ?>" />-->
			<?php
		...
		<tr>
			...
			<td><!--<input type="text" name="end_date" size="20" value="0000-00-00 00:00:00" />-->
			<?php 
...
<tr>
	<td colspan="2" align="center">
		...
		<tr>
			<td><img src="components/com_yos_resources_manager/assets/images/edit.png" title="" /></td>
