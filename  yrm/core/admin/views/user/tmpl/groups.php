...
<?php
	JToolBarHelper::title(  JText::_( 'USER_GROUPS_MANAGER').' [<small><small>'.$this->user->username.'</small></small>]' );
?>
...
<div id="tablecell">
	...
	<thead>
		<tr>
			...
			<th width="15%">
				<?php echo JHTML::_('grid.sort',   'Start', 'r.start', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
			<th width="15%">
				<?php echo JHTML::_('grid.sort',   'End', 'r.end', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
			<th width="40%">
