...
class YRMViewUser extends JView
{
	function display($tpl = null){
		...
		$say 		= JText::sprintf('RESOURCES_BANNED_MANAGER', $model->user->username);		
	...
	{
		JToolBarHelper::title( JText::_( 'USER_RESOURCES_BANNED_MANAGER' ), 'addedit' );
		JToolBarHelper::save('save_resources_banned');
		JToolBarHelper::apply('apply_resources_banned');
