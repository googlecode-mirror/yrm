...
/**
*
* @version $Id: uninstall.php $
* @package YRM
* @license	GNU/GPL http://www.gnu.org/copyleft/gpl.html
* 
* http://yopensource.com
* We used the Joom!fish addon installer script. Below is the copyright info.
*
...
<h2>YOS Resources Manager Removal</h2>
<table class="adminlist">
	...
	<tbody>
		<tr class="row0">
			<td class="key" colspan="2"><?php echo 'YOS Resources Manager '.JText::_('Component'); ?></td>
